...
namespace nc
{
	...
	public:
		...
		void Create(Vector2& position, size_t count, float lifetime, const Color& color, float minSpeed, float maxSpeed, float direction, float rotation, float angleRange);
